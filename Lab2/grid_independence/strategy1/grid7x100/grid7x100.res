 ...
 ************************************************************
 ...
 Number used before BFC allowance is                          36955
 Number used after BFC allowance is                           36955
 ************************************************************
 ...
 ************************************************************
 biggest cell volume divided by average is     1.85714234285713       at:
 ix = 1 iy = 7 iz = 7
 xg =0.26 yg =0.046429 zg =0.52
 smallest cell volume divided by average is   0.142857057142868       at:
 ix = 1 iy = 1 iz = 57
 xg =0.26 yg =3.571428E-03 zg =4.52
 ratio of smallest to biggest is   7.692305207100567E-002
 ************************************************************
 ...
 ************************************************************
 ...
 PATCH(OB2 ,HIGH , 1, 1, 1, 7, 100, 100, 1, 1)
 COVAL(OB2 ,P1 ,1000. ,0. )
 COVAL(OB2 ,V1 ,0. ,0. )
 COVAL(OB2 ,W1 ,0. ,0. )
 COVAL(OB2 ,KE ,0. , SAME )
 ...
 PATCH(OB3 ,NWALL , 1, 1, 7, 7, 1, 100, 1, 1)
 COVAL(OB3 ,W1 , GRND2 ,0. )
 COVAL(OB3 ,KE , GRND2 , GRND2 )
 COVAL(OB3 ,EP , GRND2 , GRND2 )
 
 PATCH(KESOURCE,PHASEM, 1, 1, 1, 7, 1, 100, 1, 1)
 ...
 *** grid-geometry information ***
 ...
 Y-coordinates of the (higher) cell faces
    7.143E-03   1.429E-02   2.143E-02   2.857E-02   3.571E-02
    4.286E-02   5.000E-02
 Z-coordinates of the (higher) cell faces
    8.000E-02   1.680E+00   3.280E+00   4.880E+00   6.480E+00

 
 Total number of F-array elements used is                     37802
 --- INTEGRATION OF EQUATIONS BEGINS ---
 
 ************************************************************
 Run ending on sweep   349 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 350
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 350
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     9.947E-01   2.085E-10      2.074E-10
     V1     1.110E+00   2.606E-07      2.892E-07
     W1     1.110E+00   9.024E-06      1.002E-05
     KE     4.636E-02   6.991E-06      3.241E-07
     EP     2.171E-01   3.429E-06      7.444E-07
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     1.696E-04   4.353E+02      6.406E-01 (    1,    7,   81)
     V1     2.156E-08   1.295E-03     -1.818E-03 (    1,    3,  100)
     W1     1.684E-06   9.188E-01      6.124E-01 (    1,    1,   90)
     KE     6.295E-08   5.852E-03      1.000E-10 (    1,    3,  100)
     EP     1.033E-07   5.023E-02      1.000E-10 (    1,    4,   96)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) =-3.953579E-04
 pos. sum=0. neg. sum=-3.953579E-04
 nett sum=-3.953579E-04
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 3.649760E-01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-3.692235E-01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-2.779468E-01
 pos. sum=0.364976 neg. sum=-0.64717
 nett sum=-0.282194
 ...
 nett sum=-9.992007E-16
 
 Nett source of KE   at patch named: OB1      (INLE1       ) = 2.737320E-17 (Average  5.625000E-17)
 Nett source of KE   at patch named: OB2      (OUTL2       ) =-1.571505E-03 (Ave Out  3.229350E-03 In  0.000000E+00)
 Nett source of KE   at patch named: OB3      (PLAT3       ) =-9.227088E-15
 Nett source of KE   at patch named: KESOURCE                =-2.227691E-02
 Non-linearised source for KE    at: KESOURCE                = 2.169901E-02
 pos. sum=0.021699 neg. sum=-0.023848
 nett sum=-2.149403E-03
 
 Nett source of EP   at patch named: OB1      (INLE1       ) = 6.747009E-24 (Average  1.386463E-23)
 Nett source of EP   at patch named: OB2      (OUTL2       ) =-6.073963E-03 (Ave Out  1.248160E-02 In  0.000000E+00)
 Nett source of EP   at patch named: OB3      (PLAT3       ) =-1.076830E-13
 Nett source of EP   at patch named: KESOURCE                =-1.161158E-01
 Non-linearised source for EP    at: KESOURCE                = 8.706402E-02
 pos. sum=0.087064 neg. sum=-0.12219
 nett sum=-0.035126
 
 
 ************************************************************
 Summary of sources from all Objects/Patches at sweep   350
    Variable      Inflow        Outflow       Nett
       P1       4.866346E-01 -4.866346E-01 -9.992007E-16
       V1       0.000000E+00 -3.953579E-04 -3.953579E-04
       W1       3.649760E-01 -6.471704E-01 -2.821944E-01
       KE       2.169901E-02 -2.384841E-02 -2.149403E-03
       EP       8.706402E-02 -1.221897E-01 -3.512573E-02
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 7 IZMON= 12 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1           KE           EP  
      1   0.0000E+00   0.0000E+00   1.0000E-10   1.0000E-10   1.0000E-10
    151   3.7403E+02   0.0000E+00   6.2331E-01   4.4482E-03   3.3288E-02
    301   3.7578E+02   0.0000E+00   6.2331E-01   4.4482E-03   3.3288E-02
   Variable    1 = P1     2 = V1     3 = W1     4 = KE     5 = EP  
     Minval=  0.000E+00  0.000E+00  1.000E-10  1.000E-10  1.000E-10
     Maxval=  3.758E+02  0.000E+00  6.233E-01  4.448E-03  3.329E-02
     Cellav=  2.499E+02  0.000E+00  4.155E-01  2.965E-03  2.219E-02
 1.00 +....+....+....+....+....5....+....+....+....+....5
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1           KE           EP  
      1   1.1000E+00   4.5170E-11   2.4913E-01   3.7937E-10   6.9814E-10
    151   6.9451E-08   5.0319E-05   7.2301E-03   5.6984E-03   3.1298E-03
    301   8.1789E-10   1.1974E-06   5.6972E-05   4.6284E-05   2.3410E-05
   Variable    1 = P1     2 = V1     3 = W1     4 = KE     5 = EP  
     Minval= -2.092E+01 -2.382E+01 -9.773E+00 -2.169E+01 -2.108E+01
     Maxval=  9.531E-02 -9.897E+00 -1.390E+00 -5.168E+00 -5.767E+00
 1.00 3....+....+....+....+....5....+....+....+....+....+
      .                                                 .
 0.90 +                                                 +
      .                                                 .
...
Variable= Sk.Fr.Co, at patch named: OB3      and  IX=     1
 IY=     7  3.284E-03  3.431E-03  3.413E-03  3.407E-03  3.409E-03
 IZ=          1         21         41         61         81
 ...
 ************************************************************
 ...
 Run started at 05:17:42 on Monday, 24 November 2025                           
 Run completed at 05:17:44 on Monday, 24 November 2025                         
 CPU time of run 4 s
 This includes 4 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 3.265E-06
 ************************************************************
