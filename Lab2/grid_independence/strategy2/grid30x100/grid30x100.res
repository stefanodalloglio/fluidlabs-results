 ...
 ************************************************************
 ...
 Number used before BFC allowance is                         148582
 Number used after BFC allowance is                          148582
 ************************************************************
 ...
 ************************************************************
 biggest cell volume divided by average is     1.96705333200000       at:
 ix = 1 iy = 30 iz = 7
 xg =0.26 yg =0.049167 zg =0.52
 smallest cell volume divided by average is   3.333286666829956E-002  at:
 ix = 1 iy = 1 iz = 57
 xg =0.26 yg =8.333275E-04 zg =4.52
 ratio of smallest to biggest is   1.694558359249387E-002
 ************************************************************
 ...
 ************************************************************
 ...
 PATCH(KESOURCE,PHASEM, 1, 1, 1, 30, 1, 100, 1, 1)
 ...
 *** grid-geometry information ***
 ...
 Total number of F-array elements used is                    149544
 --- INTEGRATION OF EQUATIONS BEGINS ---
 
 ************************************************************
 Run ending on sweep  1218 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 1219
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 1219
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     9.944E-01   2.966E-11      2.950E-11
     V1     1.116E+00   3.036E-07      3.387E-07
     W1     1.116E+00   9.828E-06      1.097E-05
     KE     1.127E-01   4.591E-07      5.175E-08
     EP     1.400E+00   1.191E-07      1.668E-07
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     4.498E-05   4.329E+02      5.855E-01 (    1,   30,   83)
     V1     4.809E-09   2.116E-03     -2.703E-03 (    1,   13,   84)
     W1     2.907E-07   9.276E-01      4.816E-01 (    1,    1,   93)
     KE     6.524E-09   7.091E-03      1.000E-10 (    1,   15,  100)
     EP     1.430E-08   2.871E-01      1.000E-10 (    1,   29,   89)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) =-5.227122E-04
 pos. sum=0. neg. sum=-5.227122E-04
 nett sum=-5.227122E-04
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 3.649760E-01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-3.707741E-01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-2.745965E-01
 pos. sum=0.364976 neg. sum=-0.645371
 nett sum=-0.280395
 ...
 nett sum=-7.21645E-16
 
 Nett source of KE   at patch named: OB1      (INLE1       ) = 2.737320E-17 (Average  5.625000E-17)
 Nett source of KE   at patch named: OB2      (OUTL2       ) =-1.472941E-03 (Ave Out  3.026793E-03 In  0.000000E+00)
 Nett source of KE   at patch named: OB3      (PLAT3       ) =-8.062552E-15
 Nett source of KE   at patch named: KESOURCE                =-5.489513E-02
 Non-linearised source for KE    at: KESOURCE                = 5.576622E-02
 pos. sum=0.055766 neg. sum=-0.056368
 nett sum=-6.018467E-04
 
 Nett source of EP   at patch named: OB1      (INLE1       ) = 6.747009E-24 (Average  1.386463E-23)
 Nett source of EP   at patch named: OB2      (OUTL2       ) =-8.529337E-03 (Ave Out  1.752719E-02 In  0.000000E+00)
 Nett source of EP   at patch named: OB3      (PLAT3       ) =-3.897700E-13
 Nett source of EP   at patch named: KESOURCE                =-7.760853E-01
 Non-linearised source for EP    at: KESOURCE                = 6.016224E-01
 pos. sum=0.601622 neg. sum=-0.784615
 nett sum=-0.182992
 
 
 ************************************************************
 Summary of sources from all Objects/Patches at sweep  1219
    Variable      Inflow        Outflow       Nett
       P1       4.866346E-01 -4.866346E-01 -7.216450E-16
       V1       0.000000E+00 -5.227122E-04 -5.227122E-04
       W1       3.649760E-01 -6.453706E-01 -2.803946E-01
       KE       5.576622E-02 -5.636807E-02 -6.018467E-04
       EP       6.016224E-01 -7.846146E-01 -1.829922E-01
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 27 IZMON= 99 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1           KE           EP  
      1   0.0000E+00   9.9999E-11   1.0000E-10   1.0000E-10   1.0000E-10
    501   4.0459E+00   1.6467E-04   6.7839E-01   3.8993E-03   2.1480E-02
   1001   4.0411E+00   1.6509E-04   6.7828E-01   3.9019E-03   2.1489E-02
   Variable    1 = P1     2 = V1     3 = W1     4 = KE     5 = EP  
     Minval=  0.000E+00  1.000E-10  1.000E-10  1.000E-10  1.000E-10
     Maxval=  4.046E+00  1.651E-04  6.784E-01  3.902E-03  2.149E-02
     Cellav=  2.696E+00  1.099E-04  4.522E-01  2.600E-03  1.432E-02
 1.00 +....+....+....+....+....5....+....+....+....+....5
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1           KE           EP  
    ...
    501   8.4770E-10   2.0772E-05   8.6140E-04   7.2560E-05   1.4694E-05
   1001   7.0096E-11   1.1741E-06   4.0255E-05   2.0629E-06   5.1224E-07
   Variable    1 = P1     2 = V1     3 = W1     4 = KE     5 = EP  
     Minval= -2.338E+01 -2.381E+01 -1.012E+01 -2.145E+01 -2.084E+01
     Maxval=  9.531E-02 -1.078E+01 -1.390E+00 -9.531E+00 -1.113E+01
 1.00 3....+....+....+....+....5....+....+....+....+....+
      .                                                 .
 0.90 +                                                 +
      .                                                 .
...
Variable= Sk.Fr.Co, at patch named: OB3      and  IX=     1
 IY=    30  5.000E-03  5.473E-03  5.433E-03  5.423E-03  5.427E-03
 IZ=          1         21         41         61         81
 ...
 ************************************************************
 ...
 Run started at 06:52:24 on Monday, 24 November 2025                           
 Run completed at 06:52:36 on Monday, 24 November 2025                         
 CPU time of run 13 s
 This includes 13 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 7.110E-07
 ************************************************************
